...
////////////////////////////////////////////////////////////////////////////////
__global__ void
transformKernel(float *g_odata, int width, hipTextureObject_t tex)
{
...
main(int argc, char **argv)
{
    ...
    checkHIPErrors(hipMalloc3DArray(&cu_3darray, &channelDesc, make_hipExtent(width, width, num_faces), hipArrayCubemap));
    ...
    hipLaunchKernelGGL(transformKernel, dim3(dimGrid), dim3(dimBlock ), 0, 0, d_data, width, tex);  // warmup (for better timing)
    ...
    // execute the kernel
    hipLaunchKernelGGL(transformKernel, dim3(dimGrid), dim3(dimBlock), 0 , 0, d_data, width, tex);
