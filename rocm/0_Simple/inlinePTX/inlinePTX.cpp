...
int main(int argc, char **argv)
{
    ...
    int *d_ptr;
    checkHIPErrors(hipMalloc(&d_ptr, N * sizeof(int)));

    int *h_ptr;
    checkHIPErrors(hipHostMalloc(&h_ptr, N * sizeof(int)));
    ...
    int *h_d_ptr;
    checkHIPErrors(hipHostMalloc(&h_d_ptr, N *sizeof(int)));
    checkHIPErrors(hipMemcpy(h_d_ptr, d_ptr, N *sizeof(int), hipMemcpyDeviceToHost));
    ...
    checkHIPErrors(hipFree(d_ptr));
    checkHIPErrors(hipHostFree(h_ptr));
    checkHIPErrors(hipHostFree(h_d_ptr));
