...
{
    checkHIPErrors(hipMalloc((void **)&d_PartialHistograms, PARTIAL_HISTOGRAM256_COUNT * HISTOGRAM256_BIN_COUNT * sizeof(uint)));
}

//Internal memory deallocation
extern "C" void closeHistogram256(void)
{
    checkHIPErrors(hipFree(d_PartialHistograms));
}
...
)
{
    ...
    getLastHIPError("histogram256Kernel() execution failed\n");
    ...
    getLastHIPError("mergeHistogram256Kernel() execution failed\n");
}
