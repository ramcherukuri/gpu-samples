...
extern "C" void initHistogram64(void)
{
    ...
    checkHIPErrors(hipMalloc((void **)&d_PartialHistograms, MAX_PARTIAL_HISTOGRAM64_COUNT * HISTOGRAM64_BIN_COUNT * sizeof(uint)));
}
...
)
{
    ...
    getLastHIPError("histogram64Kernel() execution failed\n");
    ...
    getLastHIPError("mergeHistogram64() execution failed\n");
}
