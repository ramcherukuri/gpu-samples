...
int main(int argc, char **argv)
{
    ...
    checkHIPErrors(hipMalloc((void **)&d_A, DATA_SZ));
    checkHIPErrors(hipMalloc((void **)&d_B, DATA_SZ));
    checkHIPErrors(hipMalloc((void **)&d_C, RESULT_SZ));
    ...
    checkHIPErrors(hipMemcpy(d_A, h_A, DATA_SZ, hipMemcpyHostToDevice));
    checkHIPErrors(hipMemcpy(d_B, h_B, DATA_SZ, hipMemcpyHostToDevice));
    ...
    getLastHIPError("scalarProdGPU() execution failed\n");
    checkHIPErrors(hipDeviceSynchronize());
    sdkStopTimer(&hTimer);
    ...
    checkHIPErrors(hipMemcpy(h_C_GPU, d_C, RESULT_SZ, hipMemcpyDeviceToHost));
