...
class SegmentationTreeBuilder
{
    ...
    private:
        ...
        void initalizeData(const Graph &graph, MemoryPoolsCollection &pools)
        {
            ...
            checkHIPErrors(hipMemcpy(dVertices_.get(),
                                       &(graph.vertices[0]),
                                       sizeof(uint) * verticesCount_,
                                       hipMemcpyHostToDevice));
            checkHIPErrors(hipMemcpy(dEdges_.get(),
                                       &(graph.edges[0]),
                                       sizeof(uint) * edgesCount_,
                                       hipMemcpyHostToDevice));
            checkHIPErrors(hipMemcpy(dWeights_.get(),
                                       &(graph.weights[0]),
                                   ...
                                   Pyramid &segmentations)
        {
            ...
            hipLaunchKernelGGL(markSegments, dim3(gridDimsForVertices), dim3(blockDimsForVertices), 0 , 0, dVertices_.get(), dEdgesFlags.get(), verticesCount_);
            getLastHIPError("markSegments launch failed.");
            ...
            hipLaunchKernelGGL(getSuccessors, dim3(gridDimsForVertices), dim3(blockDimsForVertices), 0 , 0, dVertices_.get(),
             dMinScannedEdges.get(),
             dSuccessors.get(),
             verticesCount_,
             edgesCount_);
            getLastHIPError("getSuccessors launch failed.");
            ...
            hipLaunchKernelGGL(removeCycles, dim3(gridDimsForVertices), dim3(blockDimsForVertices), 0 , 0, dSuccessors.get(), verticesCount_);
            getLastHIPError("removeCycles launch failed.");
            ...
            hipLaunchKernelGGL(addScalar, dim3(gridDimsForEdges), dim3(blockDimsForEdges), 0 , 0, dStartpoints.get(), -1, edgesCount_);
            getLastHIPError("addScalar launch failed.");
            ...
            hipLaunchKernelGGL(getRepresentatives, dim3(gridDimsForVertices), dim3(blockDimsForVertices), 0 , 0, dSuccessors.get(),
             dRepresentatives.get(),
             verticesCount_);
            getLastHIPError("getRepresentatives launch failed.");
            ...
            hipLaunchKernelGGL(getVerticesMapping, dim3(gridDimsForVertices), dim3(blockDimsForVertices), 0 , 0, dClusteredVerticesIDs.get(),
             dNewVerticesIDs_.get(),
             dVerticesMapping.get(),
             verticesCount_);
            getLastHIPError("getVerticesMapping launch failed.");
            ...
            // the same successor).
            hipLaunchKernelGGL(invalidateLoops, dim3(gridDimsForEdges), dim3(blockDimsForEdges), 0 , 0, dStartpoints.get(),
             dVerticesMapping.get(),
             dEdges_.get(),
             edgesCount_);
            getLastHIPError("invalidateLoops launch failed.");
            ...
            hipLaunchKernelGGL(calculateEdgesInfo, dim3(gridDimsForEdges), dim3(blockDimsForEdges), 0 , 0, dStartpoints.get(),
             dVerticesMapping.get(),
             dEdges_.get(),
             dWeights_.get(),
             dNewStartpoints.get(),
             ...
             edgesCount_,
             newVerticesCount);
            getLastHIPError("calculateEdgesInfo launch failed.");
            ...
            hipLaunchKernelGGL(makeNewEdges, dim3(newGridDimsForEdges), dim3(newBlockDimsForEdges), 0 , 0, dSurvivedEdgesIDs.get(),
                          dVerticesMapping.get(),
                          dEdges_.get(),
                          dWeights_.get(),
                          dNewEdges.get(),
                          dNewWeights.get(),
                          validEdgesCount);
            getLastHIPError("makeNewEdges launch failed.");
