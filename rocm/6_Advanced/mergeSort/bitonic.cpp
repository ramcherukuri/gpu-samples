...
)
{
    ...
    getLastHIPError("bitonicSortSharedKernel<<<>>> failed!\n");
}
...
)
{
    ...
    if (sortDir)
    {
        hipLaunchKernelGGL(HIP_KERNEL_NAME(bitonicMergeElementaryIntervalsKernel<1U>), dim3(mergePairs), dim3(SAMPLE_STRIDE), 0, 0, 
            d_DstKey,
            d_DstVal,
            d_SrcKey,
            d_SrcVal,
    ...
    {
        hipLaunchKernelGGL(HIP_KERNEL_NAME(bitonicMergeElementaryIntervalsKernel<0U>), dim3(mergePairs), dim3(SAMPLE_STRIDE), 0, 0, 
            d_DstKey,
            d_DstVal,
            d_SrcKey,
            d_SrcVal,
