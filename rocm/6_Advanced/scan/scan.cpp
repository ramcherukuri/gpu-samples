...
{
    checkHIPErrors(hipMalloc((void **)&d_Buf, (MAX_BATCH_ELEMENTS / (4 * THREADBLOCK_SIZE)) * sizeof(uint)));
}
...
)
{
    ...
    getLastHIPError("scanExclusiveShared() execution FAILED\n");
