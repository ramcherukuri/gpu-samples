                    ...
                    const int animationFrame, const int mode, const int numSMs, const bool isJ, int version)
{
    ...
    switch (mode)
    {
        default:
        case 0:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(Mandelbrot0<float>), dim3(numWorkerBlocks), dim3(threads), 0, 0, dst, imageW, imageH, crunch, (float)xOff, (float)yOff,
        ...
        case 1:
            ...
            break;
        case 2:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(Mandelbrot0<double>), dim3(numWorkerBlocks), dim3(threads), 0, 0, dst, imageW, imageH, crunch, xOff, yOff,
                                                              xjp, yjp, scale, colors, frame, animationFrame, grid.x, grid.x *grid.y, isJ);
            break;
    }

    getLastHIPError("Mandelbrot0 kernel execution failed.\n");
} // RunMandelbrot0
                    ...
                    const int animationFrame, const int mode, const int numSMs, const bool isJ, int version)
{
    ...
    switch (mode)
    {
        default:
        case 0:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(Mandelbrot1<float>), dim3(numWorkerBlocks), dim3(threads), 0, 0, dst, imageW, imageH, crunch, (float)xOff, (float)yOff,
                                                             (float)xjp, (float)yjp, (float)scale, colors, frame, animationFrame, grid.x, grid.x *grid.y, isJ);
            break;
        case 1:
            float x0, x1, y0, y1;
            ...
            break;
        case 2:
            hipLaunchKernelGGL(HIP_KERNEL_NAME(Mandelbrot1<double>), dim3(numWorkerBlocks), dim3(threads), 0, 0, dst, imageW, imageH, crunch, xOff, yOff,
                                                              xjp, yjp, scale, colors, frame, animationFrame, grid.x, grid.x *grid.y, isJ);
            break;
    }

    getLastHIPError("Mandelbrot1 kernel execution failed.\n");
} // RunMandelbrot1
