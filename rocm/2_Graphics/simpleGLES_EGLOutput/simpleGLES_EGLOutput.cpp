...
void checkResultCuda(int argc, char **argv, const GLuint &vbo) {
  if (!d_vbo_buffer) {
    ...
    checkHIPErrors(cudaGraphicsGLRegisterBuffer(
...
static void InitGraphicsState(char **argv) {
  ...
  checkHIPErrors(cudaGraphicsGLRegisterBuffer(&cuda_vbo_resource, mesh_vbo,
...
bool runTest(int argc, char **argv, char *ref_file) {
  ...
  if (ref_file != NULL) {
    // create VBO
    checkHIPErrors(hipMalloc((void **)&d_vbo_buffer,
